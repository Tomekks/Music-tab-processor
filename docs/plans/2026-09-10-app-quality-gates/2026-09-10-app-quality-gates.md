...
- Scope is `app/` only — `pipeline/` gets no equivalent yet (see `docs/decisions/0009-agent-workflow-tooling.md`).
...
- Produces: `npm run lint` now flags complexity past 9 or nesting depth past 4 — the exact thresholds `docs/decisions/0006-stack-and-tooling.md` already validated against this repo via CodeScene.
