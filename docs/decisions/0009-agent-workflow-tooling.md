...
See also: `docs/decisions/0006-stack-and-tooling.md` (the reliability toolkit this supersedes the process-mechanics half of), `docs/decisions/0007-structure-and-methodology.md` (where the walk test itself came from), and `docs/AGENT_TOOLING_LOG.md` (the *what's installed, when* companion to this file's *why* — every plugin/skill added to the coding agent's environment, not just Superpowers).
