...
- **This tier** (`docs/GUIDE.md`, `docs/ARCHITECTURE.md`, `docs/DECISIONS.md`, `docs/AUDIOPROCESSINGTOOLS.md`, `docs/DRIFT_CHECK.md`, `docs/DRIFT_LOG.md`, `docs/SESSION_HANDOFF.md`, `docs/PENDING_ACTIONS.md`) — plain language, for a human keeping track of their own project. What things do, why they exist, what's been decided and why.
