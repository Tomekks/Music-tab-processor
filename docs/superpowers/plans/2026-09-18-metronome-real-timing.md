...
- Only touch `lib/tabNotation.ts`, `hooks/useMetronome.ts`, `app/_components/StudioTabs.tsx`, `components/SheetDiagram.RULES.md`, and `docs/decisions/display-modes.md`. No other file's behavior changes.
...
- Modify: `docs/decisions/display-modes.md:29`
...
- [ ] **Step 2: Update `docs/decisions/display-modes.md`'s Metronome note**

In `docs/decisions/display-modes.md`, replace the sentence (currently within line 29):
...
```bash
git add app/components/SheetDiagram.RULES.md docs/decisions/display-modes.md
