...
**Status:** deployed and live at **https://app-six-psi-70.vercel.app** (2026-09-09), confirmed rendering real data from the database on the actual production URL — including the tabbed UI, Sheet, and the metronome, verified live, not just committed. Reads live from the Turso database (`s05_publish` writes to it); a homepage (song list) and a per-song page with three switchable tab views (Sheet, Fretboard, Ascii) plus a metronome. See `docs/ARCHITECTURE.md` for how this fits the whole system, `docs/decisions/hosting-and-deployment.md` for why Turso/Drizzle specifically.
