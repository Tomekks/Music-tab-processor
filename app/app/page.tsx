...
// short-lived caches (docs/plans/specs/song-list-cache.md,
// docs/plans/specs/song-detail-streaming.md) -- not re-queried from Turso every time.
...
export default async function HomePage({
  ...
  // Cached (2026-09-19, docs/plans/specs/song-list-cache.md): songs only change via
  ...
  // in via Suspense (2026-09-19, docs/plans/specs/song-detail-streaming.md) so a
